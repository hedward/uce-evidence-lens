...
Status: **v1.0.0 release candidate with MPL-2.0 adopted and the GitHub repository public; release evidence, video, and final submission steps remain.**
...
3. Review the public GitHub repository configuration; configure branch protection and private vulnerability reporting. Do not enable unreviewed third-party actions.
